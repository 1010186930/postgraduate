...
#define LCD_LED        	GPIO_Pin_12  //PB9 连接至TFT -LED
//接口定义在Lcd_Driver.h内定义，请根据接线修改并修改相应IO初始化LCD_GPIO_Init()
#define LCD_CTRL   	  	GPIOB		//定义TFT数据端口
#define LCD_CTRL_C   	GPIOC
#define LCD_RS         	GPIO_Pin_1	//PB1连接至TFT --RS
#define LCD_CS        	GPIO_Pin_8 //PB8 连接至TFT --CS
#define LCD_RST     	GPIO_Pin_10	//PC12连接至TFT --RST
#define LCD_SCL        	GPIO_Pin_8	//PB13连接至TFT -- CLK
#define LCD_SDA        	GPIO_Pin_9	//PB15连接至TFT - SDI
							    
//////////////////////////////////////////////////////////////////////
//液晶控制口置1操作语句宏定义
#define	LCD_CS_SET  	LCD_CTRL->BSRR=LCD_CS    
#define	LCD_RS_SET  	LCD_CTRL->BSRR=LCD_RS    
#define	LCD_SDA_SET  	LCD_CTRL_C->BSRR=LCD_SDA    
#define	LCD_SCL_SET  	LCD_CTRL_C->BSRR=LCD_SCL    
#define	LCD_RST_SET  	LCD_CTRL_C->BSRR=LCD_RST    
#define	LCD_LED_SET  	LCD_CTRL->BSRR=LCD_LED   

//液晶控制口置0操作语句宏定义
#define	LCD_CS_CLR  	LCD_CTRL->BRR=LCD_CS    
#define	LCD_RS_CLR  	LCD_CTRL->BRR=LCD_RS    
#define	LCD_SDA_CLR  	LCD_CTRL_C->BRR=LCD_SDA    
#define	LCD_SCL_CLR  	LCD_CTRL_C->BRR=LCD_SCL    
#define	LCD_RST_CLR  	LCD_CTRL_C->BRR=LCD_RST    
