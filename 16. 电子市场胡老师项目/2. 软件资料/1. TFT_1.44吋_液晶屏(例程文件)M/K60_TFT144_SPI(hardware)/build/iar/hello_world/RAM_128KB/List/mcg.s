...
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  C:\Users\Ping\Desktop\K60_TFT144_SPI\src\drivers\mcg\mc /
//                    g.c                                                     /
//    Command line =  C:\Users\Ping\Desktop\K60_TFT144_SPI\src\drivers\mcg\mc /
//                    g.c -D IAR -D TWR_K60N512 -lCN                          /
...
// C:\Users\Ping\Desktop\K60_TFT144_SPI\src\drivers\mcg\mcg.c
//    1 /*
//    2  * File:    mcg.c
...
//   44      MCG_C2 = 0;
??pll_init_2:
        LDR.W    R0,??DataTable15  ;; 0x40064001
        MOVS     R1,#+0
        STRB     R1,[R0, #+0]
//   45 #else
...
//   51     SIM_SCGC4 |= SIM_SCGC4_LLWU_MASK;
        LDR.W    R0,??DataTable15_1  ;; 0x40048034
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x10000000
        LDR.W    R1,??DataTable15_1  ;; 0x40048034
        STR      R0,[R1, #+0]
//   52     LLWU_CS |= LLWU_CS_ACKISO_MASK;
        LDR.W    R0,??DataTable15_2  ;; 0x4007c008
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x80
        LDR.W    R1,??DataTable15_2  ;; 0x4007c008
        STRB     R0,[R1, #+0]
//   53   
...
//   56   MCG_C1 = MCG_C1_CLKS(2) | MCG_C1_FRDIV(3);
        LDR.W    R0,??DataTable15_3  ;; 0x40064000
        MOVS     R1,#+152
        STRB     R1,[R0, #+0]
//   57 
...
??pll_init_3:
        LDR.W    R0,??DataTable15_4  ;; 0x40064006
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+27
        BMI.N    ??pll_init_3
//   64 
...
//   70    MCG_C5 = MCG_C5_PRDIV(0x18);
        LDR.W    R0,??DataTable15_5  ;; 0x40064004
        MOVS     R1,#+24
        STRB     R1,[R0, #+0]
//   71 #else
...
//   79   MCG_C6 = 0x0;
        LDR.W    R0,??DataTable15_6  ;; 0x40064005
        MOVS     R1,#+0
        STRB     R1,[R0, #+0]
...
//  123   MCG_C1 &= ~MCG_C1_CLKS_MASK;
        ...
        LDRB     R0,[R0, #+0]
        ANDS     R0,R0,#0x3F
        LDR.W    R1,??DataTable15_3  ;; 0x40064000
        STRB     R0,[R1, #+0]
//  124 
...
//  183     MCG_C6 &= ~MCG_C6_PLLS_MASK;  // Clear PLLS to select FLL, still running system from ext OSC.
        LDR.W    R1,??DataTable15_6  ;; 0x40064005
        LDRB     R1,[R1, #+0]
        ANDS     R1,R1,#0xBF
        LDR.W    R2,??DataTable15_6  ;; 0x40064005
        STRB     R1,[R2, #+0]
...
//  187     MCG_C2 &= ~MCG_C2_LP_MASK;  // FLL remains active in bypassed modes.
        LDR.W    R1,??DataTable15  ;; 0x40064001
        LDRB     R1,[R1, #+0]
        ANDS     R1,R1,#0xFD
        LDR.W    R2,??DataTable15  ;; 0x40064001
        STRB     R1,[R2, #+0]
...
//  221     MCG_C4 = 0x0E;  // Low-range DCO output (~10MHz bus).  FCTRIM=%0111.
        LDR.W    R0,??DataTable15_7  ;; 0x40064003
        MOVS     R1,#+14
        STRB     R1,[R0, #+0]
...
//  236     periph_clk_khz = core_clk_khz / (((SIM_CLKDIV1 & SIM_CLKDIV1_OUTDIV2_MASK) >> 24)+ 1);        
        ...
        LDR      R0,[R0, #+0]
        LDR.W    R1,??DataTable15_10  ;; 0x40048044
        LDR      R1,[R1, #+0]
        UBFX     R1,R1,#+24,#+4
        ADDS     R1,R1,#+1
        UDIV     R0,R0,R1
...
//  254       core_clk_khz = 96000;
        LDR.W    R0,??DataTable15_9
        LDR.W    R1,??DataTable15_12  ;; 0x17700
        STR      R1,[R0, #+0]
//  255       break;  
//  256     case PLL48:
...
//  267   SIM_SCGC6 |= SIM_SCGC6_RTC_MASK;  
        LDR.W    R0,??DataTable15_13  ;; 0x4004803c
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x20000000
        LDR.W    R1,??DataTable15_13  ;; 0x4004803c
        STR      R0,[R1, #+0]
//  268 // set RTC in default state using software reset
//  269   RTC_CR |= RTC_CR_SWR_MASK; // set SWR
        LDR.W    R0,??DataTable15_14  ;; 0x4003d010
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.W    R1,??DataTable15_14  ;; 0x4003d010
        STR      R0,[R1, #+0]
...
//  279   SIM_SOPT2 |= SIM_SOPT2_MCGCLKSEL_MASK;
        LDR.W    R0,??DataTable15_15  ;; 0x40048004
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.W    R1,??DataTable15_15  ;; 0x40048004
        STR      R0,[R1, #+0]
//  280   
...
//  349   if (MCG_C4 & MCG_C4_DMX32_MASK) // if DMX32 set
        LDR.W    R2,??DataTable15_7  ;; 0x40064003
        LDRB     R2,[R2, #+0]
        LSLS     R2,R2,#+24
        BPL.N    ??fll_freq_0
//  350   {
...
??fei_fbe_8:
        ...
        ANDS     R0,R0,#0x38
        ORRS     R0,R0,#0x80
        LDR.W    R5,??DataTable15_3  ;; 0x40064000
        STRB     R0,[R5, #+0]
//  441 
...
fbe_pbe:
        ANDS     R2,R0,#0x1F
        LDR.W    R3,??DataTable15_5  ;; 0x40064004
        STRB     R2,[R3, #+0]
//  474 
...
??fbe_pbe_0:
        LDR.W    R2,??DataTable15_4  ;; 0x40064006
        LDRB     R2,[R2, #+0]
        LSLS     R2,R2,#+26
        BPL.N    ??fbe_pbe_0
//  479 
...
//  488   MCG_C1 &= ~MCG_C1_CLKS_MASK; // switch CLKS mux to select PLL as MCG_OUT
        LDR.W    R3,??DataTable15_3  ;; 0x40064000
        LDRB     R3,[R3, #+0]
        ANDS     R3,R3,#0x3F
        LDR.W    R4,??DataTable15_3  ;; 0x40064000
        STRB     R3,[R4, #+0]
//  489   // Wait for clock status bits to update 
//  490   while (((MCG_S & MCG_S_CLKST_MASK) >> MCG_S_CLKST_SHIFT) != 0x3){} 
??pbe_pee_0:
        LDR.W    R3,??DataTable15_4  ;; 0x40064006
        LDRB     R3,[R3, #+0]
        UBFX     R3,R3,#+2,#+2
...
//  493   vdiv = ((MCG_C6 & MCG_C6_VDIV_MASK) + 24);
        LDR.W    R3,??DataTable15_6  ;; 0x40064005
        LDRB     R3,[R3, #+0]
        ANDS     R3,R3,#0x1F
        ADDS     R3,R3,#+24
        MOVS     R2,R3
...
fbe_fbi_fast:
        ...
        LDRB     R1,[R1, #+0]
        ORRS     R1,R1,#0x1
        LDR.N    R2,??DataTable15  ;; 0x40064001
        STRB     R1,[R2, #+0]
//  521   
//  522   temp_reg = MCG_C1;
        LDR.W    R1,??DataTable15_3  ;; 0x40064000
...
fbe_fbi_slow:
        LDR.N    R1,??DataTable15  ;; 0x40064001
        LDRB     R1,[R1, #+0]
        ANDS     R1,R1,#0xFE
        LDR.N    R2,??DataTable15  ;; 0x40064001
        STRB     R1,[R2, #+0]
...
fbi_blpi:
        LDR.N    R0,??DataTable15  ;; 0x40064001
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x2
        LDR.N    R1,??DataTable15  ;; 0x40064001
        STRB     R0,[R1, #+0]
...
??atc_1:
        LDR.N    R0,??DataTable15_3  ;; 0x40064000
        LDRB     R0,[R0, #+0]
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LSRS     R0,R0,#+6
        MOV      R10,R0
...
??atc_3:
        ...
        CMP      R10,#+0
        BNE.N    ??atc_5
        LDR.N    R0,??DataTable15_6  ;; 0x40064005
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+25
        BMI.N    ??atc_5
        LDR.N    R0,??DataTable15_3  ;; 0x40064000
...
??atc_5:
        LDR.N    R0,??DataTable15_4  ;; 0x40064006
        LDRB     R0,[R0, #+0]
        UBFX     R0,R0,#+2,#+2
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        CMP      R0,#+3
...
??atc_7:
        LDR.N    R0,??DataTable15_27  ;; 0x2dc6c0
        CMP      R5,R0
        BGE.N    ??atc_10
//  610           {
...
??atc_10:
        LDR.N    R0,??DataTable15_29  ;; 0x4c4b41
        CMP      R5,R0
        BLT.N    ??atc_9
//  615           {
...
??atc_12:
        LDR.N    R0,??DataTable15_10  ;; 0x40048044
        LDR      R0,[R0, #+0]
        MOV      R8,R0
...
//  628           atcv = (unsigned short)(128.0f * (21.0f * (16000000.0f / (float)irc_freq))); 
        ...
        BL       __aeabi_i2f
        MOVS     R1,R0
        LDR.N    R0,??DataTable15_31  ;; 0x4b742400
        BL       __aeabi_fdiv
        LDR.N    R1,??DataTable15_32  ;; 0x41a80000
        BL       __aeabi_fmul
        MOVS     R1,#+1124073472
        BL       __aeabi_fmul
        BL       __aeabi_f2iz
...
//  650           printf("MCG_C3   = %#02X \r\n", (MCG_C3));
        LDR.N    R0,??DataTable15_39  ;; 0x40064002
        LDRB     R1,[R0, #+0]
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable15_40
        BL       printf
//  651           printf("MCG_C4   = %#02X \r\n", (MCG_C4)) ;
        LDR.N    R0,??DataTable15_7  ;; 0x40064003
        LDRB     R1,[R0, #+0]
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        LDR.N    R0,??DataTable15_41
        BL       printf
//  652           printf("MCG_C5   = %#02X \r\n", (MCG_C5));
        LDR.N    R0,??DataTable15_5  ;; 0x40064004
        LDRB     R1,[R0, #+0]
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
...
//  657           printf("MCG_ATVCH = %#02X \r\n",   (MCG_ATCVH));
        LDR.N    R0,??DataTable15_34  ;; 0x4006400a
        LDRB     R1,[R0, #+0]
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
...
//  658           MCG_ATC |= MCG_ATC_ATMF_MASK; // clear fail flag
        ...
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x20
        LDR.N    R1,??DataTable15_35  ;; 0x40064008
        STRB     R0,[R1, #+0]
//  659           return 7;
        MOVS     R0,#+7
        B.N      ??atc_4
