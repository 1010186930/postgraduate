...
//#define LCD_LED        	 // 连接至TFT -LED
//接口定义在Lcd_Driver.h内定义，请根据接线修改并修改相应IO初始化LCD_GPIO_Init()
//#define LCD_CTRL   	  	 		//定义TFT数据端口
//#define LCD_CTRL2   	  	 		//定义TFT数据端口
//#define LCD_RS         	 	 //PB1连接至TFT --RS
//#define LCD_CS        	         // 连接至TFT --CS
//#define LCD_RST     	   	         // 连接至TFT --RST
//#define LCD_SCL        	 	 //PB13连接至TFT -- CLK
//#define LCD_SDA        	 	 //PB15连接至TFT - SDI
